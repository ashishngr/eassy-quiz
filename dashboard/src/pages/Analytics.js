...
const Analytics = () => {
  ...
  useEffect(() => {
    fetchQuizRatingsData("allTime");
    fetchQuizCompletionData("allTime");
    fetchQuizCount("allTime");
    fetchParticipantCount("allTime");
    fetchQuizByScope("allTime");
  }, []);
            ...
            >
              <List>
                ...
                <ListItem button>
                  <ListItemText
                    primary="This Week"
                    onClick={() => handleFilterChange("oneWeek")}
                  />
                </ListItem>
                <ListItem button>
                  <ListItemText
                    primary="This Month"
                    onClick={() => handleFilterChange("oneMonth")}
                  />
                </ListItem>
                <ListItem button>
                  <ListItemText
                    primary="Last Six Months"
