...
const Login = () => {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center">
      <form
        className="w-full max-w-md px-8 py-6 bg-white rounded shadow-md border border-gray-300"
        ...
        <div className="mb-4 ">
          ...
          <div class="relative flex items-center">
            <input
              ...
              id="password"
              name="password"
              class="w-full px-3 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500 pl-10"
            ...
            >
              {showPassword ? (
                ...
                <FaRegEyeSlash className="w-5 h-5 text-gray-500 hover:text-gray-700" />
              )}
            </button>
          </div>
        </div>
