...
const SideBar = () => {
  return (
    <div className="fixed top-0 left-0 z-50 h-full w-64 overflow-y-auto bg-white  text-lg font-sans subpixel-antialiased transition duration-300 ease-in-out flex flex-col items-center border-solid border-r-4 border-light-blue-500">
